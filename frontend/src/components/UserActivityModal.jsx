    ...
    return (
        ...
        >
            <div className="space-y-6">
                {error && <div className="p-3 bg-rose-500 text-white rounded-xl text-[10px] font-bold uppercase tracking-widest">{error}</div>}

                <div className="flex items-center gap-4 p-4 bg-indigo-500/5 border border-indigo-500/20 rounded-2xl mb-4">
                    <div className="p-2 bg-indigo-500 text-white rounded-xl shadow-sm shadow-indigo-500/20"><Shield size={20}/></div>
                    <div>
                        <h4 className="text-[10px] font-bold text-primary uppercase tracking-[0.3em]">Access Verification Stream</h4>
                            ...
                            return (
                                <>
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2 font-bold italic text-xs text-[var(--text-main)]">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <code className="text-[10px] font-bold text-[var(--text-muted)] bg-[var(--secondary)] px-2 py-1 rounded-md">{log.ipAddress || '0.0.0.0'}</code>
                                        </div>
                                    </td>
                                    <td className="px-6 py-4">
                                        {success ? (
                                            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-emerald-500/10 text-emerald-600 rounded-full text-[9px] font-bold uppercase tracking-widest border border-emerald-500/20 italic">
                                                <CheckCircle size={10}/> Authenticated
                                            </span>
                                        ) : (
                                            <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-rose-500/10 text-rose-600 rounded-full text-[9px] font-bold uppercase tracking-widest border border-rose-500/20 italic">
