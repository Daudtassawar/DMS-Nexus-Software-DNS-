    ...
    public partial class InitialSQLite : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DailyActivities", x => x.ActivityId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_Salesmen_SalesmanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyLedgers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyLedgers_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CompanyLedgers_Users_CreatedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CustomerLedgers_Users_CreatedByUserId",
                        column: x => x.CreatedByUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "CompanyLedgers",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_CompanyLedgers_CreatedByUserId",
                table: "CompanyLedgers",
                column: "CreatedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerLedgers_CreatedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_CustomerName_Area",
                table: "Customers",
                columns: new[] { "CustomerName", "Area" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stock_ProductId_WarehouseLocation",
                table: "Stock",
                columns: new[] { "ProductId", "WarehouseLocation" },
                unique: true);
